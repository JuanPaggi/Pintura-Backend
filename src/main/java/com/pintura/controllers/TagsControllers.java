...
import com.pintura.services.TagService;
...
public class TagsControllers {
	...
	public static final Logger logger = LoggerFactory.getLogger(TagsControllers.class);
	...
	public @ResponseBody ResponseEntity<TagItem> getTagByID(@PathVariable("idTag") String idTag) {
		try {
			return new ResponseEntity<TagItem>(tagService.getTag(Integer.parseInt(idTag)), HttpStatus.OK);
	...
	public @ResponseBody ResponseEntity<ModelApiResponse> removeTag(@PathVariable("idTag") String idTag) {
		ModelApiResponse respuesta = new ModelApiResponse();
		try {
			tagService.removeTag(Integer.parseInt(idTag));
			respuesta.codigo("OK");
	...
	public @ResponseBody ResponseEntity<ModelApiResponse> editTag(@PathVariable("idTag") String idTag,
		...
		ModelApiResponse respuesta = new ModelApiResponse();
		try {
			tagService.editTag(Integer.parseInt(idTag), body);
			respuesta.codigo("OK");
